      ...
      drawerContent={(props) => (
        <View style={{ flex: 1, padding: 20 }}>
          ...
          style={estilos.drawerItem}
            ...
            <Text style={estilos.drawerIcon}><MaterialIcons name="dashboard" size={Fontes.grande1} color={Cores.primariaClara} /></Text>
        ...
        {/* SEGUNDO ITEM DO MENU (CADASTRO PRODUTOS) */}
          <TouchableOpacity
          style={estilos.drawerItem}
            onPress={() => props.navigation.navigate('ideias')}>
            <Text style={estilos.drawerIcon}><MaterialIcons name="add-circle" size={Fontes.grande1} color={Cores.primariaClara} /></Text>
          ...
          style={estilos.drawerItem}
            ...
            <Text style={estilos.drawerIcon}><MaterialIcons name="check" size={Fontes.grande1} color={Cores.primariaClara} /></Text>
          ...
          style={estilos.drawerItem}
            ...
            <Text style={estilos.drawerIcon}><MaterialIcons name="swap-vert" size={Fontes.grande1} color={Cores.primariaClara} /></Text>
        ...
        {/* QUINTO ITEM DO MENU (HISTÓRICO) */}
          ...
          style={estilos.drawerItem}
            onPress={() => props.navigation.navigate('sobre')}>
            <Text style={estilos.drawerIcon}><MaterialIcons name="history" size={Fontes.grande1} color={Cores.primariaClara} /></Text>
          ...
          style={estilos.drawerItem}
            onPress={() => props.navigation.navigate('sobre')}>
            <Text style={estilos.drawerIcon}><MaterialIcons name="bar-chart" size={Fontes.grande1} color={Cores.primariaClara} /></Text>
